  ...
  return (
    <div className="w-full min-h-screen bg-[#F1E9D2] text-[#121212] selection:bg-[#966F33] selection:text-white overflow-x-hidden">
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-12 pt-32 pb-12">
        ...
        <a 
  href="mailto:akademiadobregonastroju@gmail.com?subject=Propozycja współpracy w Akademii&body=Jeśli adresat nie ustawił się automatycznie skopiuj ten adnres e mail i wklej go jako odbiorcę akademiadobregonastroju@gmail.com ,%0D%0A%0D%0A" 
